...
const COMING_SOON = ["Orders", "Addresses", "Coupons", "Profile", "Saved Payments"];
    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-[1280px] px-4 py-6">
          ...
          <h1 className="mb-6 mt-2 text-xl font-semibold text-text-primary md:text-2xl">{title}</h1>
              ...
              <nav className="rounded-md border border-border p-2">
                <ul className="space-y-0.5 text-sm">
                  ...
                  <li className="mt-1 border-t border-border pt-1">
                    <button type="button" className="block w-full rounded px-3 py-2 text-left font-medium text-text-secondary hover:bg-surface-grey">
                      Logout
                    </button>
                  </li>
                </ul>
